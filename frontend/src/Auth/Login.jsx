    ...
    >
      ...
      <div className="w-full flex flex-col items-center justify-center p-4 tracking-wide relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#e7e5e4] uppercase tracking-[0.2em] drop-shadow-lg text-center break-words max-w-full">
            Code<span className="text-[#d4af37]">Quest</span>
          </h1>
          <p className="text-[#a8a29e] tracking-widest uppercase text-xs sm:text-sm mt-2 text-center">Teachers Portal</p>
        </div>

        {/* Login Card */}
        <div className="bg-[#1c1917] rounded-sm p-6 sm:p-8 md:p-12 shadow-[0_0_50px_rgba(0,0,0,0.8)] w-full max-w-[90%] sm:max-w-md border border-[#44403c] relative overflow-hidden">
          ...
          >
            <h2 className="text-xl sm:text-2xl font-bold text-center mb-2 text-[#e7e5e4] uppercase tracking-widest border-b border-[#292524] pb-4">
              LOGIN
            </h2>

            {/* Email */}
            <div className="flex flex-col gap-2">
              <label className="text-[10px] sm:text-xs font-bold text-[#a8a29e] uppercase tracking-widest">Email Address</label>
              <div className="flex items-center bg-[#0c0a09] border border-[#44403c] rounded p-3 focus-within:border-[#d4af37] focus-within:shadow-[0_0_10px_rgba(212,175,55,0.1)] transition-all">
                <User className="w-5 h-5 text-[#57534e] mr-3 shrink-0" />
                <input
                  type="email"
                  className="w-full bg-transparent focus:outline-none text-[#e7e5e4] placeholder-[#292524] text-sm"
            ...
            {/* Password */}
            <div className="flex flex-col gap-2">
              <label className="text-[10px] sm:text-xs font-bold text-[#a8a29e] uppercase tracking-widest">Password</label>
              <div className="flex items-center bg-[#0c0a09] border border-[#44403c] rounded p-3 focus-within:border-[#d4af37] focus-within:shadow-[0_0_10px_rgba(212,175,55,0.1)] transition-all">
                <Lock className="w-5 h-5 text-[#57534e] mr-3 shrink-0" />
                <input
